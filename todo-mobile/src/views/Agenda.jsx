...
const styles = StyleSheet.create({
  ...
  dayHeader: { flex: 1, alignItems: 'center', paddingVertical: 8, backgroundColor: 'rgba(255,102,179,0.12)' },
  dayHeaderText: { fontSize: 11, fontWeight: '700', color: COLORS.pinkDark, textTransform: 'uppercase' },
  cell: { flex: 1, minHeight: 60, padding: 3, borderRightWidth: 0.5, borderRightColor: 'rgba(0,0,0,0.06)' },
  cellOut: { backgroundColor: 'rgba(0,0,0,0.03)' },
  cellToday: { backgroundColor: 'rgba(255,102,179,0.15)' },
